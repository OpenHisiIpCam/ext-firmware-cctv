...
static __inline HI_VOID hi_ext_system_isp_raw_position_write(VI_PIPE ViPipe, HI_U32 data)
{
    IOWR_32DIRECT(VREG_TOP_BASE(ViPipe) + 0x300, data);
}

static __inline HI_U32 hi_ext_system_isp_raw_position_read(VI_PIPE ViPipe)
{
    return IORD_32DIRECT(VREG_TOP_BASE(ViPipe) + 0x300);
}


#define  HI_EXT_SYSTEM_ISP_RAW_POSITION_ENABLE_WRITE_DEFAULT  0
static __inline HI_VOID hi_ext_system_isp_raw_position_enable_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_TOP_BASE(ViPipe) + 0x304, (data & 0x01));
}

static __inline HI_U8 hi_ext_system_isp_raw_position_enable_read(VI_PIPE ViPipe)
{
    return (IORD_8DIRECT(VREG_TOP_BASE(ViPipe) + 0x304) & 0x01);
}
...
static __inline HI_VOID hi_ext_system_demosaic_manual_colornoise_thdf_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_DM_BASE(ViPipe) + 0x80, data);
}
static __inline HI_U8 hi_ext_system_demosaic_manual_colornoise_thdf_read(VI_PIPE ViPipe)
{
...
static __inline HI_VOID hi_ext_system_demosaic_manual_colornoise_strf_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_DM_BASE(ViPipe) + 0x81, data);
}
static __inline HI_U8 hi_ext_system_demosaic_manual_colornoise_strf_read(VI_PIPE ViPipe)
{
...
// ------------------------------------------------------------------------------ //
// args: data (8-bit)
#define HI_EXT_SYSTEM_DEMOSAIC_MANUAL_DESAT_DARK_RANGE_DEFAULT  (30)
#define HI_EXT_SYSTEM_DEMOSAIC_MANUAL_DESAT_DARK_RANGE_DATASIZE (1)
static __inline HI_VOID hi_ext_system_demosaic_manual_desat_dark_range_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_DM_BASE(ViPipe) + 0x82, data);
}
static __inline HI_U8 hi_ext_system_demosaic_manual_desat_dark_range_read(VI_PIPE ViPipe)
{
...
static __inline HI_VOID hi_ext_system_demosaic_manual_desat_dark_strength_write(VI_PIPE ViPipe, HI_U8 data)
{
    IOWR_8DIRECT(VREG_DM_BASE(ViPipe) + 0x83, data);
}
static __inline HI_U8 hi_ext_system_demosaic_manual_desat_dark_strength_read(VI_PIPE ViPipe)
{
...
static __inline HI_VOID hi_ext_system_demosaic_auto_colornoise_thdf_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT(VREG_DM_BASE(ViPipe) + 0x90 + (u8Index * sizeof(HI_U8)), data);
}
static __inline HI_U8 hi_ext_system_demosaic_auto_colornoise_thdf_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return IORD_8DIRECT(VREG_DM_BASE(ViPipe) + 0x90 + (u8Index * sizeof(HI_U8)));
}
...
static __inline HI_VOID hi_ext_system_demosaic_auto_colornoise_strf_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT(VREG_DM_BASE(ViPipe) + 0xa0 + (u8Index * sizeof(HI_U8)), data);
}
static __inline HI_U8 hi_ext_system_demosaic_auto_colornoise_strf_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return IORD_8DIRECT(VREG_DM_BASE(ViPipe) + 0xa0 + (u8Index * sizeof(HI_U8)));
}
...
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_demosaic_auto_desat_dark_range_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT(VREG_DM_BASE(ViPipe) + 0xb0 + (u8Index * sizeof(HI_U8)), data);
}
static __inline HI_U8 hi_ext_system_demosaic_auto_desat_dark_range_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return IORD_8DIRECT(VREG_DM_BASE(ViPipe) + 0xb0 + (u8Index * sizeof(HI_U8)));
}
...
// args: data (8-bit)
static __inline HI_VOID hi_ext_system_demosaic_auto_desat_dark_strength_write(VI_PIPE ViPipe, HI_U8 u8Index, HI_U8 data)
{
    IOWR_8DIRECT(VREG_DM_BASE(ViPipe) + 0xc0 + (u8Index * sizeof(HI_U8)), data);
}
static __inline HI_U8 hi_ext_system_demosaic_auto_desat_dark_strength_read(VI_PIPE ViPipe,  HI_U8 u8Index)
{
    return IORD_8DIRECT(VREG_DM_BASE(ViPipe) + 0xc0 + (u8Index * sizeof(HI_U8)));
}
