...
#define XM_ERR_VO_NULL_PTR                                                     \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_NULL_PTR)
#define XM_ERR_VO_SYS_NOTREADY                                                 \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_SYS_NOTREADY)
#define XM_ERR_VO_INVALID_DEVID                                                \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_DEVID)
#define XM_ERR_VO_INVALID_CHNID                                                \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_CHNID)
#define XM_ERR_VO_ILLEGAL_PARAM                                                \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_ILLEGAL_PARAM)
#define XM_ERR_VO_NOT_SUPPORT                                                  \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_SUPPORT)
#define XM_ERR_VO_NOT_PERMIT                                                   \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_PERM)
#define XM_ERR_VO_INVALID_WBCID                                                \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_WBCID)
#define XM_ERR_VO_INVALID_LAYERID                                              \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_LAYERID)

/* device relative error code */
#define XM_ERR_VO_DEV_NOT_CONFIG                                               \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_VO_DEV_NOT_CONFIG)
#define XM_ERR_VO_DEV_NOT_ENABLE                                               \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_VO_DEV_NOT_ENABLE)
#define XM_ERR_VO_DEV_HAS_ENABLED                                              \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_VO_DEV_HAS_ENABLED)
#define XM_ERR_VO_DEV_HAS_BINDED                                               \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_VO_DEV_HAS_BINDED)
#define XM_ERR_VO_DEV_NOT_BINDED                                               \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_VO_DEV_NOT_BINDED)

/* video relative error code */
#define XM_ERR_VO_VIDEO_NOT_ENABLE                                             \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_NOT_ENABLE)
#define XM_ERR_VO_VIDEO_NOT_DISABLE                                            \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_NOT_DISABLE)
#define XM_ERR_VO_VIDEO_NOT_CONFIG                                             \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_NOT_CONFIG)
#define XM_ERR_VO_VIDEO_HAS_BINDED                                             \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_VO_VIDEO_HAS_BINDED)
#define XM_ERR_VO_VIDEO_NOT_BINDED                                             \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, EN_ERR_VO_VIDEO_NOT_BINDED)

/*wbc error code*/
#define XM_ERR_VO_WBC_NOT_DISABLE                                              \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_WBC_NOT_DISABLE)
#define XM_ERR_VO_WBC_NOT_CONFIG                                               \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_WBC_NOT_CONFIG)
#define XM_ERR_VO_WBC_HAS_CONFIG                                               \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_WBC_HAS_CONFIG)
#define XM_ERR_VO_WBC_NOT_BIND                                                 \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_WBC_NOT_BIND)
#define XM_ERR_VO_WBC_HAS_BIND                                                 \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_WBC_HAS_BIND)

/* channel relative error code */
#define XM_ERR_VO_CHN_NOT_DISABLE                                              \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_CHN_NOT_DISABLE)
#define XM_ERR_VO_CHN_NOT_ENABLE                                               \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_CHN_NOT_ENABLE)
#define XM_ERR_VO_CHN_NOT_CONFIG                                               \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_CHN_NOT_CONFIG)
#define XM_ERR_VO_CHN_NOT_ALLOC                                                \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_CHN_NOT_ALLOC)
#define XM_ERR_VO_CHN_AREA_OVERLAP                                             \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_CHN_AREA_OVERLAP)

/* cascade relatvie error code */
#define XM_ERR_VO_INVALID_PATTERN                                              \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_CCD_INVALID_PAT)
#define XM_ERR_VO_INVALID_POSITION                                             \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_CCD_INVALID_POS)

/* misc */
#define XM_ERR_VO_WAIT_TIMEOUT                                                 \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_WAIT_TIMEOUT)
#define XM_ERR_VO_INVALID_VFRAME                                               \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_INVALID_VFRAME)
#define XM_ERR_VO_INVALID_RECT_PARA                                            \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_INVALID_RECT_PARA)
#define XM_ERR_VO_SETBEGIN_ALREADY                                             \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_SETBEGIN_ALREADY)
...
#define XM_ERR_VO_SETEND_NOTYET                                                \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_SETEND_NOTYET)

/* sync group relative error code */
#define XM_ERR_VO_GRP_INVALID_ID                                               \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_INVALID_ID)
#define XM_ERR_VO_GRP_NOT_CREATE                                               \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_NOT_CREATE)
#define XM_ERR_VO_GRP_HAS_CREATED                                              \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_HAS_CREATED)
#define XM_ERR_VO_GRP_NOT_DESTROY                                              \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_NOT_DESTROY)
#define XM_ERR_VO_GRP_CHN_FULL                                                 \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_CHN_FULL)
#define XM_ERR_VO_GRP_CHN_EMPTY                                                \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_CHN_EMPTY)
#define XM_ERR_VO_GRP_CHN_NOT_EMPTY                                            \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_CHN_NOT_EMPTY)
#define XM_ERR_VO_GRP_INVALID_SYN_MODE                                         \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_INVALID_SYN_MODE)
#define XM_ERR_VO_GRP_INVALID_BASE_PTS                                         \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_INVALID_BASE_PTS)
#define XM_ERR_VO_GRP_NOT_START                                                \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_NOT_START)
#define XM_ERR_VO_GRP_NOT_STOP                                                 \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_NOT_STOP)
#define XM_ERR_VO_GRP_INVALID_FRMRATE                                          \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_INVALID_FRMRATE)
#define XM_ERR_VO_GRP_CHN_HAS_REG                                              \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_CHN_HAS_REG)
#define XM_ERR_VO_GRP_CHN_NOT_REG                                              \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_CHN_NOT_REG)
#define XM_ERR_VO_GRP_CHN_NOT_UNREG                                            \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_CHN_NOT_UNREG)
#define XM_ERR_VO_GRP_BASE_NOT_CFG                                             \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_VO_GRP_BASE_NOT_CFG)

/* graphics relative error code */
#define XM_ERR_VO_GFX_NOT_DISABLE                                              \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_GFX_NOT_DISABLE)
#define XM_ERR_VO_GFX_NOT_BIND                                                 \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_GFX_NOT_BIND)
#define XM_ERR_VO_GFX_NOT_UNBIND                                               \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_GFX_NOT_UNBIND)
#define XM_ERR_VO_GFX_INVALID_ID                                               \
  XM_DEF_ERR(XM_ID_VOU, EN_ERR_LEVEL_ERROR, ERR_GFX_INVALID_ID)
...
#define VO_DEFAULT_CHN -1 /* use vo buffer as pip buffer */
  ...
  {
    VO_WBC_MODE_NOMAL = 0, /* In this mode, wbc will capture frames according to
                              dev frame rate and wbc frame rate */
    VO_WBC_MODE_DROP_REPEAT,  /* In this mode, wbc will drop dev repeat frame,
                                 and capture the real frame  according to video
                                 layer's display rate and wbc frame rate */
    VO_WBC_MODE_PROG_TO_INTL, /* In this mode, wbc will drop dev repeat frame
                                 which repeats more than 3 times,
                                       and change two progressive frames to one
                                 interlace frame */
  ...
  {
    VO_CAS_DATA_SINGLE_TRAN_MODE = 0, /* single transition,clock rising edge or
                                         clock falling edge tigger transition */
    VO_CAS_DATA_DOUBLE_TRAN_MODE,     /* double transition,clock rising edge and
                                         clock falling edge tigger transition */
  ...
  typedef struct xmVO_CAS_ATTR_S
  {
    ...
    VO_CAS_DATA_TRAN_MODE_E
      enCasDataTranMode; /* cascade data transition mode  */
  } VO_CAS_ATTR_S;
  ...
  typedef struct xmVO_VGA_PARAM_S
  {
    ...
    XM_S32 s32SharpenStrength; /* current sharpen strength of VGA signals. [0,
                                  255]. default:0x80 */
  } VO_VGA_PARAM_S;
