...
extern "C"
{
  ...
  XM_S32 XM_MPI_VO_SetChnAttr(VO_LAYER VoLayer,
                              VO_CHN VoChn,
                              const VO_CHN_ATTR_S* pstChnAttr);
  XM_S32 XM_MPI_VO_GetChnAttr(VO_LAYER VoLayer,
                              VO_CHN VoChn,
                              VO_CHN_ATTR_S* pstChnAttr);

  XM_S32 XM_MPI_VO_GetChnFrame(VO_LAYER VoLayer,
                               VO_CHN VoChn,
                               VIDEO_FRAME_INFO_S* pstFrame,
                               XM_S32 s32MilliSec);
  XM_S32 XM_MPI_VO_ReleaseChnFrame(VO_LAYER VoLayer,
                                   VO_CHN VoChn,
  ...
  /*XM_S32 XM_MPI_VO_SendFrame(VO_LAYER VoLayer, VO_CHN VoChn,
   * VIDEO_FRAME_INFO_S *pstVFrame, XM_S32 s32MilliSec);*/

  /*XM_S32 XM_MPI_VO_ClearChnBuffer(VO_LAYER VoLayer, VO_CHN VoChn, XM_BOOL
   * bClrAll);*/

  /*XM_S32 XM_MPI_VO_GetChnRegionLuma(VO_LAYER VoLayer, VO_CHN VoChn,
  ...
  /*XM_S32 XM_MPI_VO_CascadePosBindChn(XM_U32 u32Pos, VO_DEV VoCasDev, VO_CHN
   * VoChn);*/
  /*XM_S32 XM_MPI_VO_CascadePosUnBindChn(XM_U32 u32Pos, VO_DEV VoCasDev, VO_CHN
   * VoChn);*/
  ...
  /*XM_S32 XM_MPI_VO_EnableRecvFrameRateMatch (VO_LAYER VoLayer, VO_CHN
   * VoChn);*/
  /*XM_S32 XM_MPI_VO_DisableRecvFrameRateMatch (VO_LAYER VoLayer, VO_CHN
   * VoChn);*/

  /* HDMI setting */
  /*XM_S32 XM_MPI_VO_GetHdmiParam(VO_DEV VoDev, VO_HDMI_PARAM_S
   * *pstHdmiParam);*/
  /*XM_S32 XM_MPI_VO_SetHdmiParam(VO_DEV VoDev, VO_HDMI_PARAM_S
   * *pstHdmiParam);*/

  /*XM_S32 XM_MPI_VO_SetVtth(VO_DEV VoDev, XM_U32 u32Vtth);*/
  /*XM_S32 XM_MPI_VO_GetVtth(VO_DEV VoDev, XM_U32* pu32Vtth);*/

  XM_S32 XM_MPI_VO_SetImageLayerAttr(VO_LAYER VoLayer,
                                     const VO_IMAGE_LAYER_ATTR_S* pstLayerAttr);
  XM_S32 XM_MPI_VO_GetImageLayerAttr(VO_LAYER VoLayer,
                                     const VO_IMAGE_LAYER_ATTR_S* pstLayerAttr);
