...
extern "C"
{
  ...
  XM_S32 XM_MPI_VENC_GetStream(VENC_CHN VeChn,
  ...
  XM_S32 XM_MPI_VENC_EncodeJpeg(VIDEO_FRAME_INFO_S const* pframe,
                                JPEG_ENC_ATTR_S* pstAttr,
                                VENC_STREAM_S* pstStream);
  XM_S32 XM_MPI_VENC_SetJpegParam(VENC_CHN VeChn,
                                  const VENC_PARAM_JPEG_S* pstJpegParam);
  XM_S32 XM_MPI_VENC_GetJpegParam(VENC_CHN VeChn,
