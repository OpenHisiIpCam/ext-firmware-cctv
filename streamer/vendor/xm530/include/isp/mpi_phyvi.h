...
typedef struct _mipi_dev_attr_s
{
  ...
  XM_U32 MipiCtrl;  //[23:16]:ctrl_dly(¼ì²â sotÊ±¼ä
                   //delay:ctrl_dly*2);[7:0]:sot_data(B8);[8]:clk_ctrl(0:CKp;1:CKn)
                   //[15:9]:±£Áô
} MIPI_DEV_ATTR_S;
...
XM_S32
XM_MPI_MIPI_GetDevAttr(ISP_DEV IspDev, COMBO_DEV_ATTR_S* pstComboDevAttr);
XM_S32
XM_MPI_MIPI_SetDevAttr(ISP_DEV IspDev,
                       MIPI_CMD enCmd,
                       const COMBO_DEV_ATTR_S* pstComboDevAttr);
...
*****************************************************************************************************/
XM_S32
XM_MPI_MIPI_RefreshFV(XM_U32 u32DelayMs, XM_U32 u32TotalSizeV);
#endif /*__MPI_ISP_H__ */
