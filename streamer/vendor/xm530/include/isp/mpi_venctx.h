...
XM_S32
XM_MPI_VENC_SetScaler(const VENC_SCALER_ATTR* pstVenAttr);
XM_S32
XM_MPI_VENC_GetScaler(VENC_SCALER_ATTR* pstVenAttr);
...
... 输出参数:	无 返回参数:	0: 成功 -1: 出错 Note:	Lycai
****************************************************************************/
XM_S32
XM_MPI_VENCTX_SetMode(XM_U8 u8VencMode, XM_U8 u8VstdType, XM_U8 u8RsltType);
