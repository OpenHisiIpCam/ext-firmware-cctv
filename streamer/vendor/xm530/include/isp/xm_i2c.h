...
#define I2C_UNMASK_ALL                                                         \
  (I2C_UNMASK_START | I2C_UNMASK_END | I2C_UNMASK_SEND | I2C_UNMASK_RECEIVE |  \
   I2C_UNMASK_ACK | I2C_UNMASK_ARBITRATE | I2C_UNMASK_OVER)
...
#define I2C_CLEAR_ALL                                                          \
  (I2C_CLEAR_START | I2C_CLEAR_END | I2C_CLEAR_SEND | I2C_CLEAR_RECEIVE |      \
   I2C_CLEAR_ACK | I2C_CLEAR_ARBITRATE | I2C_CLEAR_OVER)
...
int
XM_I2C_WriteConfig(unsigned char dev_addr);
int
XM_I2C_Write(unsigned char dev_addr,
             unsigned int reg_addr,
             unsigned int addr_byte_num,
             unsigned int data,
             unsigned int data_byte_num);
int
XM_I2C_Read(unsigned char dev_addr,
            unsigned int reg_addr,
            unsigned int addr_byte_num,
            unsigned int data_byte_num);
