...
/* invlalid channel ID */
#define XM_ERR_VENC_INVALID_CHNID                                              \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_CHNID)
/* at lease one parameter is illagal ,eg, an illegal enumeration value  */
#define XM_ERR_VENC_ILLEGAL_PARAM                                              \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_ILLEGAL_PARAM)
/* channel exists */
#define XM_ERR_VENC_EXIST                                                      \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_EXIST)
/* channel exists */
#define XM_ERR_VENC_UNEXIST                                                    \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_UNEXIST)
/* using a NULL point */
#define XM_ERR_VENC_NULL_PTR                                                   \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_NULL_PTR)
/* try to enable or initialize system,device or channel, before configing
 * attribute */
#define XM_ERR_VENC_NOT_CONFIG                                                 \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_CONFIG)
/* operation is not supported by NOW */
#define XM_ERR_VENC_NOT_SUPPORT                                                \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_SUPPORT)
/* operation is not permitted ,eg, try to change stati attribute */
#define XM_ERR_VENC_NOT_PERM                                                   \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_PERM)
/* encode one frame not finish,maybe bus error,timeout,sys reset and so on */
#define XM_ERR_VENC_NOT_FINISH                                                 \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_FINISH)
/* insufficient resource*/
#define XM_ERR_VENC_INSUFF_RES                                                 \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_INSUFF_RES)
/* failure caused by malloc memory */
#define XM_ERR_VENC_NOMEM                                                      \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_NOMEM)
/* failure caused by malloc buffer */
#define XM_ERR_VENC_NOBUF                                                      \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_NOBUF)
/* no data in buffer */
#define XM_ERR_VENC_BUF_EMPTY                                                  \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_EMPTY)
/* no buffer for new data */
#define XM_ERR_VENC_BUF_FULL                                                   \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_FULL)
/* system is not ready,had not initialed or loaded*/
#define XM_ERR_VENC_SYS_NOTREADY                                               \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_SYS_NOTREADY)
/* encoder hardware init or config failed */
#define XM_ERR_VENC_HW_FAILED                                                  \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_HW_FAILED)
/* system is busy*/
#define XM_ERR_VENC_BUSY XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_BUSY)
/* undefined error */
#define XM_ERR_VENC_UND_ERROR                                                  \
  XM_DEF_ERR(XM_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_UND)
  ...
  typedef enum xmH264E_REF_TYPE_E
  {
    ...
    BASE_PSLICE_REFBYBASE, // the P frame at Base layer, referenced by other
                           // frames at Base layer
    BASE_PSLICE_REFBYENHANCE, // the P frame at Base layer, referenced by other
                              // frames at Enhance layer
    ENHANCE_PSLICE_REFBYENHANCE, // the P frame at Enhance layer, referenced by
                                 // other frames at Enhance layer
  ...
  typedef struct xmVENC_STREAM_INFO_H264_S
  {
    ...
    H264E_REF_TYPE_E enRefType; /*Type of encoded frames in advanced frame
                                   skipping reference mode*/
    XM_U32 u32UpdateAttrCnt;    /*Number of times that channel attributes or
  ...
  typedef struct xmVENC_STREAM_INFO_H265_S
  {
    ...
    H265E_REF_TYPE_E enRefType; /*Type of encoded frames in advanced frame
                                   skipping reference mode*/
    XM_U32 u32UpdateAttrCnt;    /*Number of times that channel attributes or
                                   parameters (including RC parameters) are set*/
  ...
  {
    XM_U32
      u32MaxPicWidth; /*maximum width of a picture to be encoded, in pixel*/
    XM_U32
      u32MaxPicHeight; /*maximum height of a picture to be encoded, in pixel*/
  ...
  typedef struct xmVENC_CHN_STAT_S
  {
    ...
    XM_U32
      u32LeftRecvPics; /*Number of frames to be received. This member is valid
                          after HI_MPI_VENC_StartRecvPicEx is called.*/
    XM_U32
      u32LeftEncPics; /*Number of frames to be encoded. This member is valid
                         after HI_MPI_VENC_StartRecvPicEx is called.*/
  } VENC_CHN_STAT_S;

  typedef struct xmVENC_PARAM_H264_SLICE_SPLIT_S
  {
    XM_BOOL bSplitEnable; /*slice split enable, XM_TRUE:enable, HI_FALSE:diable,
                             default value:HI_FALSE*/
    XM_U32 u32SplitMode;  /*0:bit number, 1:mb line number, >=2:no meaning*/
    XM_U32 u32SliceSize;  /*when the splitmode is 0, this value presents the
                            bitsnum of one slice average,  when the splitmode is
                            1, this value presents the mb num of one slice*/
  ...
  typedef struct xmVENC_PARAM_H264_INTER_PRED_S
  {
    ...
    /* inter pred, one of the following 4 kinds of inter prediction mode must be
     * enable */
  ...
  typedef struct xmVENC_PARAM_H264_INTRA_PRED_S
  {
    ...
    XM_BOOL
      bIntra16x16PredEn; /*default: XM_TRUE, enable 16x16 intra prediction*/
    XM_BOOL
      bIntraNxNPredEn; /*default: XM_TRUE, enable 4x4 and/or 8x8 prediction
                         Notes: this value must work with IntraTransMode*/
    XM_U32
      constrained_intra_pred_flag; /*default: HI_FALSE, see the H.264 protocol*/
  ...
  {
    XM_U32
      u32IntraTransMode; /* 0: trans4x4, trans8x8; 1: trans4x4, 2: trans8x8 */
    XM_U32
      u32InterTransMode; /* 0: trans4x4, trans8x8; 1: trans4x4, 2: trans8x8 */

    XM_BOOL bScalingListValid; /* default: HI_FALSE */
    /* Notes: Enable IntraScalingList8X8 and InterScalingList8X8 while
     * bScalingListValid is XM_TRUE */
  ...
  {
    XM_U8 timing_info_present_flag; /* default value: 0. If 1, timing info
                                       belows will be encoded into vui. {0,1} */
  ...
  {
    XM_U8 aspect_ratio_info_present_flag; /* default value: 0. If 1, aspectratio
                                             info belows will be encoded into
                                             vui. {0,1} */
    XM_U8
      aspect_ratio_idc; /* default value: n/a. [0,255],17~254 is reserved. */
    XM_U8 overscan_info_present_flag; /* default value: 0,just be 0.If 1,
                                         oversacan info belows will be encoded
                                         into vui. {0,1} */
    XM_U8 overscan_appropriate_flag;  /* default value: n/a. */
    XM_U16 sar_width;  /* default value: n/a. sar_width  and  sar_height  shall
                          be  relatively  prime. */
  ...
  {
    XM_U8
      video_signal_type_present_flag; /* default value: 0. If 1, video singnal
                                         info will be encoded into vui. {0,1} */
    ...
    XM_U8
      colour_primaries; /* default value: n/a. [0,255],0/9~255 is reserved */
    XM_U8 transfer_characteristics; /* default value: n/a. [0,255],0/13~255 is
                                       reserved */
    XM_U8
      matrix_coefficients; /* default value: n/a. [0,255],9~255 is reserved */
  ...
  typedef struct xmVENC_PARAM_MPEG4_S
  {
    ...
    XM_U32 u32SplitMode;  /*0:bit number, 1:mb line number, >=2:no meaning*/
    XM_U32
      u32PacketSize; /*when the splitmode is 0, this value presents the bitsnum
                        of one packet average, when the splitmode is 1, this
                        value presents the mb num of one packet*/
  ...
  {
    XM_U32 u32Index; /* Index of an ROI. The system supports indexes ranging
                        from 0 to 7 */
    XM_BOOL bEnable; /* Whether to enable this ROI */
    XM_BOOL
      bAbsQp; /* QP mode of an ROI.HI_FALSE: relative QP.HI_TURE: absolute QP.*/
  ...
  typedef struct xmVENC_PARAM_REF_S
  {
    ...
    XM_BOOL bEnablePred; /*Whether some frames at the base layer are referenced
                            by other frames at the base layer. When bEnablePred
                            is HI_FALSE, all frames at the base layer reference
                            IDR frames.*/
  } VENC_PARAM_REF_S;
  ...
  {
    H264E_IDR_PIC_ID_MODE_E
      enH264eIdrPicIdMode;   /*the mode of idr_pic_id that is set*/
  ...
  {
    XM_S32 s32RecvPicNum; /*Number of frames received and encoded by the
                             encoding channel*/
