...
typedef enum xm_EN_ERR_CODE_E
{
  ...
  EN_ERR_NOT_FINISH = 10, /* encode one frame not finish,maybe bus
                             error,timeout,sys reset and so on*/
...
** #define XM_ERR_MD_INVALID_CHNID XM_DEF_ERR(XM_ID_VDA, EN_ERR_LEVEL_ERROR,
