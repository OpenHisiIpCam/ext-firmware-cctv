...
XM_S32
Write_IspRegSys(XM_U32 u32Addr, XM_U32 u32Value);
XM_S32
Read_IspRegSys(XM_U32 u32Addr);

void
SysDelay_ms(XM_S32 ms);
XM_S32
SysGetProductInfo(XM_PRODUCT_INFO* pstProductInfo);
XM_S32
SysSetProductInfo(XM_PRODUCT_INFO* pstProductInfo);
int
...
XM_U8
putstr(XM_U8 uart_NO, char const* str);
void
SysFlagSet(XM_U32 u32Flag);
#endif
