...
XM_S32
ExtCfg_BaseAddrGet(XM_U8 u8Sns, XM_U32 u32Module, XM_U32* pu32Addr);
...
************************************************************************/
XM_S32
ExtCft_GetSnsIdx(XM_U8 u8SnsID, XM_U8* pu8SnsIdx);

// 设置sensor 的索引 (确认匹配上Sensor)
XM_S32
ExtCfg_SetSnsIdx(XM_U8 u8SnsIdx, XM_U8 u8SnsAdWidth, XM_U8 u8SnsDtWidth);

// 获取SensorID
XM_S32
ExtCft_GetSnsId(XM_U8* pu8SnsId);

// 获取配置文件中的Sensor个数
XM_S32
ExtCft_GetSnsNum(XM_U8* pu8Num);
...
*********************************************************/
XM_S32
ExtCft_GetIspWndRect(XM_U8 u8Fps, RECT_S* pstRect);

//获取分辨率
XM_S32
ExtCft_GetSnsResolution(XM_U8* pu8Res);

// u8Mode:    	0: Common Funciton
//			1: Sensor Function
//验证是否支持该功能(功能是否使用外部配置)
XM_S32
ExtCfg_CheckFun(XM_U8 u8Mode, XM_U32 u32Fun);

XM_S32
ExtCfg_PN_IspSet(XM_U8 u8Encode, XM_U8 u8VstdMode);

// u8DnMode:   	0: Color		1:BW
// u8XviEn:		0:Disable		1:Enable
XM_S32
ExtCfg_SetMode(XM_U8 u8XviEn, XM_U8 u8DnMode);
...
************************************************************************/
XM_S32
ExtCfg_Gamma_Get(XM_U8* pu8Mode, GAMMA_DATA_DN_S* pstGamm);
/************************************************************************
函数功能:	获取GammaTable
...
************************************************************************/
XM_S32
ExtCfg_GammaTab_Get(XM_U8 u8GmId, XM_U16* pu16Tab);
...
// 获取Other参数
XM_S32
ExtCfg_Other_Get(OHTER_DATA_S* pstData);

// 初始化ISP 寄存器
XM_S32
ExtCfg_IspRegInit(XM_U8 u8Mode);
...
//从Flash/E2PROM中读取
XM_S32
ExtCfg_Read_V2(XM_U8 u8Bytes, XM_U32 u32Add, XM_U8* pu8Data);

XM_S32
ExtCfg_Write_V2(XM_U16 u16Bytes, XM_U32 u32Add, XM_U8* pu8Data);

//写入Flash/E2PROM
XM_S32
ExtCfg_Write(XM_U8 u8Bytes, XM_U32 u32Addr, XM_U8* pu8Data);
...
XM_S32
ExtCft_WriteIsp(XM_U8 u8Mode, XM_U32 u32Addr, XM_U16 u16Num);
...
输入参数:	u8Mode:
                                        ...
                                        1:  获取GainLogic地址
输出参数:	*pu32Data:
                                        GainMode (u8Mode == 0) GainLogic
BaseAddr  	(u8Mode == 1) 返回参数:	-1:  failed/ not exist 0:    Ok/exit
************************************************************************/
XM_S32
ExtCft_GainModeGet(XM_U8 u8Mode, XM_U32* pu32Data);
...
***********************************************************************/
XM_S32
ExtCft_GetVersion(XM_U8* pau8Data);
...
***********************************************************************/
XM_S32
ExtCfg_VencSet(XM_U8 u8VencMode);

XM_S32
ExtCfg_Read_RAM(XM_U8 u8Bytes, XM_U32 u32Add, XM_U8* pu8Data);

XM_S32
ExtCfg_CCM_Set(ISP_COLORMATRIX_AUTO_S* pstCCM);

XM_S32
ExtCfg_IspDataInit(XM_U8 u8Venc, XM_U8 u8Std);

XM_S32
ExtCfg_Init(XM_U8* pu8Buffer);

XM_S32
ExtCfg_Nr3DInit(NR3D_INIT_S* pstNr3D);

XM_S32
ExtCfg_StabDeal(STABDEAL_S* pstStabDeal);

XM_S32
ExtCfg_AeAwbInit(XM_U8 u8Mode, XM_U8 u8Vstd);
...
void
PrintInt(unsigned char u8Num, int u32Data);
void
PrintHex(unsigned char u8Num, int u32Data);
