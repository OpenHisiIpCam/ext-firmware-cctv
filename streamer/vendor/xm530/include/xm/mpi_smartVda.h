...
//灯泡移动侦测检测的接口
XM_S32
MoveDetect_Creat(int nChannel);
XM_S32
MoveDetect_SetParam(int nChannel, Move_Detect_Para_S* pstParam);
XM_S32
MoveDetect_GetResult(int nChannel,
                     Move_Detect_Result_S* pstResult); //返回 1:有目标  0:无目标
XM_S32
MoveDetect_Destory(int nChannel);
