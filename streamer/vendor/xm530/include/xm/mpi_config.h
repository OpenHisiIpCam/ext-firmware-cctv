...
**********************************************************************/
XM_S32
XM_MPI_MENU_SetMode(XM_MENU_MODE enMode);
XM_S32
XM_MPI_MENU_GetMode(XM_MENU_MODE* penMode);
...
**********************************************************************/
XM_S32
XM_MPI_MENU_SaveCfg(XM_U32 u32Cmd, XM_S32 s32Data);
...
****************************************************************************/
XM_S32
XM_MPI_MENU_SaveDefCfg(XM_U32* pu32Cmd, XM_U16* pu16Data, XM_U8 u8Num);

/**********************************************************************
函数功能:	保存菜单配置文件(=> NowConfiFile)
输入参数:	u8Mode:	0	To NowCofnig(will Save to Falsh)
                                                1	To DefaultConfig(will
Save to Falsh) 0x10:	To NowCofnig(Not Save) u32Cmd:		指定(地址)
                                *pu32Data:	对应值
...
**********************************************************************/
XM_S32
XM_MPI_MENU_SetCfg(XM_U8 u8Mode, XM_U32 u32Cmd, XM_U32* pu32Data);

/**********************************************************************
函数功能:	配置文件同步
输入参数:	u8Mode
                                        0:	default configFile	->
Config 1:	const default data	-> Config 2:	Auto
**********************************************************************/
XM_S32
XM_MPI_MENU_CfgSync(XM_U8 u8Mode);
...
**********************************************************************/
XM_S32
XM_MPI_MENU_LoadCfg(XM_U32 u32Cmd);

/**********************************************************************
函数功能:	配置文件同步
输入参数:	u8Mode
                                        0:	default configFile 	->
Config 1:    const default data 	-> Config 输出参数:	无 返回参数:
0: Success -1: Failure
**********************************************************************/
XM_S32
XM_MPI_MENU_SetDefault(XM_U8 u8Mode);
