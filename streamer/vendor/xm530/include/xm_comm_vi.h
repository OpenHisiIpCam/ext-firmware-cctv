...
#define XM_ERR_VI_INVALID_PARA                                                 \
  XM_DEF_ERR(XM_ID_VIU, EN_ERR_LEVEL_ERROR, EN_ERR_ILLEGAL_PARAM)
#define XM_ERR_VI_INVALID_DEVID                                                \
  XM_DEF_ERR(XM_ID_VIU, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_DEVID)
#define XM_ERR_VI_INVALID_CHNID                                                \
  XM_DEF_ERR(XM_ID_VIU, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_CHNID)
#define XM_ERR_VI_INVALID_NULL_PTR                                             \
  XM_DEF_ERR(XM_ID_VIU, EN_ERR_LEVEL_ERROR, EN_ERR_NULL_PTR)
#define XM_ERR_VI_FAILED_NOTCONFIG                                             \
  XM_DEF_ERR(XM_ID_VIU, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_CONFIG)
#define XM_ERR_VI_SYS_NOTREADY                                                 \
  XM_DEF_ERR(XM_ID_VIU, EN_ERR_LEVEL_ERROR, EN_ERR_SYS_NOTREADY)
#define XM_ERR_VI_BUF_EMPTY                                                    \
  XM_DEF_ERR(XM_ID_VIU, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_EMPTY)
#define XM_ERR_VI_BUF_FULL                                                     \
  XM_DEF_ERR(XM_ID_VIU, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_FULL)
#define XM_ERR_VI_NOMEM XM_DEF_ERR(XM_ID_VIU, EN_ERR_LEVEL_ERROR, EN_ERR_NOMEM)
#define XM_ERR_VI_NOT_SUPPORT                                                  \
  XM_DEF_ERR(XM_ID_VIU, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_SUPPORT)
#define XM_ERR_VI_BUSY XM_DEF_ERR(XM_ID_VIU, EN_ERR_LEVEL_ERROR, EN_ERR_BUSY)
#define XM_ERR_VI_NOT_PERM                                                     \
  XM_DEF_ERR(XM_ID_VIU, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_PERM)
...
#define XM_ERR_VI_FAILED_NOTENABLE                                             \
  XM_DEF_ERR(                                                                  \
    XM_ID_VIU, EN_ERR_LEVEL_ERROR, ERR_VI_FAILED_NOTENABLE) /* 0xA0108040*/
#define XM_ERR_VI_FAILED_NOTDISABLE                                            \
  XM_DEF_ERR(                                                                  \
    XM_ID_VIU, EN_ERR_LEVEL_ERROR, ERR_VI_FAILED_NOTDISABLE) /* 0xA0108041*/
#define XM_ERR_VI_FAILED_CHNOTDISABLE                                          \
  XM_DEF_ERR(                                                                  \
    XM_ID_VIU, EN_ERR_LEVEL_ERROR, ERR_VI_FAILED_CHNOTDISABLE) /* 0xA0108042*/
#define XM_ERR_VI_CFG_TIMEOUT                                                  \
  XM_DEF_ERR(XM_ID_VIU, EN_ERR_LEVEL_ERROR, ERR_VI_CFG_TIMEOUT) /* 0xA0108043*/
#define XM_ERR_VI_NORM_UNMATCH                                                 \
  XM_DEF_ERR(XM_ID_VIU, EN_ERR_LEVEL_ERROR, ERR_VI_NORM_UNMATCH) /* 0xA0108044*/
#define XM_ERR_VI_INVALID_WAYID                                                \
  XM_DEF_ERR(                                                                  \
    XM_ID_VIU, EN_ERR_LEVEL_ERROR, ERR_VI_INVALID_WAYID) /* 0xA0108045*/
#define XM_ERR_VI_INVALID_PHYCHNID                                             \
  XM_DEF_ERR(                                                                  \
    XM_ID_VIU, EN_ERR_LEVEL_ERROR, ERR_VI_INVALID_PHYCHNID) /* 0xA0108046*/
#define XM_ERR_VI_FAILED_NOTBIND                                               \
  XM_DEF_ERR(                                                                  \
    XM_ID_VIU, EN_ERR_LEVEL_ERROR, ERR_VI_FAILED_NOTBIND) /* 0xA0108047*/
#define XM_ERR_VI_FAILED_BINDED                                                \
  XM_DEF_ERR(                                                                  \
    XM_ID_VIU, EN_ERR_LEVEL_ERROR, ERR_VI_FAILED_BINDED) /* 0xA0108048*/
  ...
  {
    /*The input sequence of the second component(only contains u and v) in
       BT.1120 mode */
  ...
  {
    VI_VSYNC_FIELD =
      0, /* Field/toggle mode:a signal reversal means a new frame or a field */
    VI_VSYNC_PULSE, /* Pusle/effective mode:a pusle or an effective signal means
                       a new frame or a field */
  } VI_VSYNC_E;
  ...
  {
    VI_VSYNC_NEG_HIGH =
      0, /*if VIU_VSYNC_E = VIU_VSYNC_FIELD,then the vertical synchronization
            signal of even field is high-level, if VIU_VSYNC_E =
            VIU_VSYNC_PULSE,then the vertical synchronization pulse is positive
            pulse.*/
    VI_VSYNC_NEG_LOW /*if VIU_VSYNC_E = VIU_VSYNC_FIELD,then the vertical
                        synchronization signal of even field is low-level, if
                        VIU_VSYNC_E = VIU_VSYNC_PULSE,then the vertical
  ...
  typedef enum xmVI_HSYNC_E
  {
    VI_HSYNC_VALID_SINGNAL =
      0,            /* the horizontal synchronization is valid signal mode */
    VI_HSYNC_PULSE, /* the horizontal synchronization is pulse mode, a new pulse
                       means the beginning of a new line */
  } VI_HSYNC_E;
  ...
  {
    VI_HSYNC_NEG_HIGH =
      0, /*if VI_HSYNC_E = VI_HSYNC_VALID_SINGNAL,then the valid horizontal
            synchronization signal is high-level; if VI_HSYNC_E =
            VI_HSYNC_PULSE,then the horizontal synchronization pulse is positive
            pulse */
    VI_HSYNC_NEG_LOW /*if VI_HSYNC_E = VI_HSYNC_VALID_SINGNAL,then the valid
                        horizontal synchronization signal is low-level; if
                        VI_HSYNC_E = VI_HSYNC_PULSE,then the horizontal
                        synchronization pulse is negative pulse */
  } VI_HSYNC_NEG_E;
  ...
  {
    VI_VSYNC_NORM_PULSE = 0, /* the vertical synchronization is pusle mode, a
                                pusle means a new frame or field  */
    VI_VSYNC_VALID_SINGAL, /* the vertical synchronization is effective mode, a
                              effective signal means a new frame or field */
  } VI_VSYNC_VALID_E;
  ...
  typedef enum xmVI_VSYNC_VALID_NEG_E
  {
    VI_VSYNC_VALID_NEG_HIGH =
      0, /*if VI_VSYNC_VALID_E = VI_VSYNC_NORM_PULSE,a positive pulse means
            vertical synchronization pulse; if VI_VSYNC_VALID_E =
            VI_VSYNC_VALID_SINGAL,the valid vertical synchronization signal is
            high-level */
    VI_VSYNC_VALID_NEG_LOW /*if VI_VSYNC_VALID_E = VI_VSYNC_NORM_PULSE,a
                              negative pulse means vertical synchronization
                              pulse; if VI_VSYNC_VALID_E =
                              VI_VSYNC_VALID_SINGAL,the valid vertical
  ...
  typedef struct xmVI_TIMING_BLANK_S
  {
    ...
    XM_U32 u32VsyncVfb;  /* Vertical front blanking height of one frame or
                            odd-field frame picture */
    XM_U32 u32VsyncVact; /* Vertical effetive width of one frame or odd-field
                            frame picture */
    XM_U32 u32VsyncVbb;  /* Vertical back blanking height of one frame or
                            odd-field frame picture */
    XM_U32
      u32VsyncVbfb; /* Even-field vertical front blanking height when input mode
                       is interlace (invalid when progressive input mode) */
    XM_U32
      u32VsyncVbact; /* Even-field vertical effetive width when input mode is
                        interlace (invalid when progressive input mode) */
    XM_U32
      u32VsyncVbbb; /* Even-field vertical back blanking height when input mode
                       is interlace (invalid when progressive input mode) */
  } VI_TIMING_BLANK_S;
  ...
  {
    BT656_FIXCODE_1 = 0, /* The highest bit of the EAV/SAV data over the BT.656
                            protocol is always 1.*/
    BT656_FIXCODE_0      /* The highest bit of the EAV/SAV data over the BT.656
  ...
  typedef enum xmBT656_FIELD_POLAR_E
  {
    BT656_FIELD_POLAR_STD =
      0, /* the standard BT.656 mode,the first filed F=0,the second filed F=1*/
    BT656_FIELD_POLAR_NSTD /* the non-standard BT.656 mode,the first filed
                              F=1,the second filed F=0*/
  } BT656_FIELD_POLAR_E;
  ...
  typedef struct xmVI_DEV_ATTR_EX_S
  {
    ...
    VI_COMP_MODE_E
      enCompMode; /* Component mode (single-component or dual-component) */
    VI_CLK_EDGE_E
    ...
    XM_S32 s32AdChnId[4]; /* AD channel ID. Typically, the default value -1 is
                             recommended */

    VI_DATA_YUV_SEQ_E
      enDataSeq; /* Input data sequence (only the YUV format is supported) */
    VI_SYNC_CFG_S stSynCfg; /* Sync timing. This member must be configured in
                               BT.601 mode or DC mode */

    VI_BT656_SYNC_CFG_S stBT656SynCfg; /* Sync timing. This member must be
                                          configured in BT.656 mode */

    VI_DATA_PATH_E enDataPath; /* ISP enable or bypass */
    VI_DATA_TYPE_E
      enInputDataType; /* RGB: CSC-709 or CSC-601, PT YUV444 disable; YUV:
                          default yuv CSC coef PT YUV444 enable. */
  ...
  {
    RECT_S stCapRect; /* the capture rect (corresponding to the size of the
                         picture captured by a VI device). For primary channels,
                         the stCapRect's u32Width and u32Height are static
                         attributes. That is, the value of them can be changed
                         only after primary and secondary channels are disabled.
                              For secondary channels, stCapRect is an invalid
                         attribute */
    SIZE_S
      stDestSize; /* Target picture size.
                          For primary channels, stDestSize must be equal to
                     stCapRect's u32Width and u32Height, because primary channel
                     doesn't have scale capability. Additionally, it is a static
                          attribute, That is, the value of stDestSize can be
                     changed only after primary and secondary channels are
                     disabled. For secondary channels, stDestSize is a dynamic
                     attribute */

    VI_CAPSEL_E
      enCapSel; /* Frame/field select. It is used only in interlaced mode.
                        For primary channels, enCapSel is a static attribute */

    PIXEL_FORMAT_E
      enPixFormat; /* Pixel storage format. Only the formats semi-planar420 and
                      semi-planar422 are supported */
    XM_BOOL bMirror;         /* Whether to mirror */
    XM_BOOL bFlip;           /* Whether to flip */
    XM_BOOL bChromaResample; /* Whether to perform chrominance resampling. It is
                                valid only for primary channels */
    XM_S32 s32SrcFrameRate;  /* Source frame rate. The value -1 indicates that
                                the frame rate is not controlled */
    XM_S32 s32FrameRate; /* Target frame rate. The value -1 indicates that the
                            frame rate is not controlled */
  } VI_CHN_ATTR_S;
  ...
  typedef struct xmVI_CHN_STAT_S
  {
    ...
    XM_U32 u32AutoDisInt; /* auto disable interrupt count, when VIU detected too
                             many interrupts */
  } VI_CHN_STAT_S;
  ...
  {
    XM_BOOL bPub; /* Whether the user picture information is shared by all VI
                     devices and channels*/
    VI_USERPIC_MODE_E enUsrPicMode; /* User picture mode */
    union
    {
      VIDEO_FRAME_INFO_S stUsrPicFrm; /* Information about a YUV picture */
      VI_USERPIC_BGC_S stUsrPicBg;    /* Information about a background picture
                                         only with a color */
    } unUsrPic;
  } VI_USERPIC_ATTR_S;
  ...
  typedef struct xmVI_FlASH_CONFIG_S
  {
    ...
    XM_U32 u32CapFrmIndex; /* Set which vframe will be bFlashed after flashing,
                              default is 0. */
